...
const DunianyaMelin = () => {
  ...
  const favorites = [
    ...
    { emoji: '📺', title: 'Normal People', desc: 'Penonton setia series "Normal People" dengan cerita yang mendalam', image: '/favorites/normal-people.webp' },
    { emoji: '🎬', title: 'Megan Fox', desc: 'Aktris favorit dengan gaya dan pesona yang memukau', image: '/favorites/megan-fox.jpg' }
  ]
